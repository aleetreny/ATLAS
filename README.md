...
> **Read it as a website.** Every technique is being turned into a visual, interactive article at **[aleetreny.github.io/ATLAS](https://aleetreny.github.io/ATLAS/)**: scrollytelling, live models running in your browser, and every number measured rather than quoted. Twenty articles published so far: regression and classification complete (modules 1.1 and 1.2, every chip lit), the opening of computer vision (1.3: classical features, Viola-Jones and convolutional networks), and a four-article arc through clustering (2.1): k-means, mixtures, density and hierarchies.
