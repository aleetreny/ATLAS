...
export function initProse(data) {
  ...
  set('closing-note',
    ...
    + `Every article in this branch was handed the same gift, which is a simulator: a rule that `
    + `says what the world does next. <a href="../collaborative-filtering/">The next module</a> `
    + `takes it away and takes something else away with it, because there the objects have no `
