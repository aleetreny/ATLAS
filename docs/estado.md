...
| 27 | Where You Weren't (escena en forma cerrada, campo de radiancia y blobs vivos, órbita arrastrable) | `nerf/` | `#7e22ce` |
...
**La sección 1 entera está cerrada: 1.1, 1.2 y, con el artículo 27, también 1.3. El 21 cumplió la promesa del 20 (ReLU gana a tanh con profundidad: 89,37/83,77 a 20 capas) y desmintió midiendo el tópico del gradiente que se desvanece (crece 1.271×). El 23 cerró el arco que abrió el 19: un clasificador de ventanas sobre un recorte y el mismo en una pasada convolucional dan el mismo número exacto. El 24 corre sobre los lienzos del 23. El 27 cierra el módulo dejando la imagen plana: la escena está escrita en forma cerrada, así que la verdad de referencia no es una anotación sino la función, y la cadena de cierres 23 -> 24 -> 27 está enganchada. El 25 abre el módulo 2.2 y recoge la promesa que dejó escrita el cierre de hierarchical. Pendientes: el resto de 2.2 (Factor Analysis/MDS, t-SNE/UMAP, Isomap/LLE/SOM, autoencoders) y los dos chips que le quedan al 2.1 después del 26, affinity propagation y spectral clustering.**
